...
public class HomePageStepDefs {
	...
	public void the_user_enters_a_search_term() {
	    System.out.println("Enter serach term: France national team t shirt");
	...
	public void the_seatch_box_should_contain_the_search_term() {
	...
	public void title_should_be_search_My_Store() {
		...
		assertEquals("My Store", Driver.getDriver().getTitle() );
		
	}
	
	@When("the user clicks on the Sing in link")
	public void the_user_clicks_on_the_Sing_in_link() {
	   HomePage homePage = new HomePage();
